...
export default function CartSummary() {
	...
	const [cartMehod, setCartMethod] = useState<string>("Pick Up");
	...
	return (
		<div className="flex flex-col rounded-lg border border-1 border-neutral-6 p-6">
			<div className="flex flex-col gap-3">
				<label
					htmlFor="1"
					className={`${cartMehod == "Free shipping" ? 'bg-neutral-4/5 border-neutral-6' : 'border-neutral-5'} duration-200 cursor-pointer flex items-center rounded border border-1 px-4 py-3 justify-between text-neutral-7`}
				>
				...
				<label
					htmlFor="2"
					className={`${cartMehod == "Express shipping" ? 'bg-neutral-4/5 border-neutral-6' : 'border-neutral-5'} duration-200 cursor-pointer flex items-center rounded border border-1 px-4 py-3 justify-between text-neutral-7`}
				>
					<div className="flex gap-2 items-center">
						<input
							className="w-4 h-4 accent-neutral-7 bg-gray-100 border-gray-300 "
				...
				<label
					htmlFor="3"
					className={`${cartMehod == "Pick Up" ? 'bg-neutral-4/5 border-neutral-6' : 'border-neutral-5'} duration-200 cursor-pointer flex items-center rounded border border-1 px-4 py-3 justify-between text-neutral-7`}
				>
					<div className="flex gap-2 items-center">
						<input
							className="w-4 h-4 accent-neutral-7 bg-gray-100 border-gray-300 "
